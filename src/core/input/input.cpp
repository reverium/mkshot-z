...
struct InputPrivate
{
    ...
    void updateControllerRaw()
    {
        ...
        memcpy(rawButtonStates, shState->eThread().controllerState.buttons, SDL_GAMEPAD_BUTTON_COUNT);
...
void Input::update()
{
    ...
    p->vScrollDistance = SDL_SetAtomicInt(&EventThread::verticalScrollDistance, 0);
