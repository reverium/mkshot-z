...
#ifdef __WIN32__
#include "core/bind/plat/rb_win0debug.hpp"
#endif
...
extern const char scripts_rgss1_rb[];
extern const char scripts_rgss2_rb[];
extern const char scripts_rgss3_rb[];
...
static void mriBindingInit() {
    ...
    */
    ...
    if (rgssVer == 1)
        rb_eval_string(scripts_rgss1_rb);
    else if (rgssVer == 2)
        rb_eval_string(scripts_rgss2_rb);
    else if (rgssVer == 3)
        rb_eval_string(scripts_rgss3_rb);
    else
        assert(!"unreachable");
